          ...
          <main className="-landing">
              ...
              <div
                ...
                <div className="authors">
                  <a
                    ...
                    >
                    <Avatar
                      src="https://pbs.twimg.com/profile_images/709460796259041281/TE5YLrp6_400x400.jpg"
                      style={styles.avatar}
                      size={50}
                      />
                    John Resig
            ...
            <section
              ...
              <p
                ...
                >
                <b>The GraphQL Guide</b>
                {` is an upcoming book on GraphQL (the best way to write an API or
                fetch data for your app). John is the creator of jQuery, the author of a couple `}
                <a href="https://en.wikipedia.org/wiki/John_Resig#Publications">
                  popular Javascript books
                </a>
                {
                  ', and the Dean of Computer Science at Khan Academy. Loren is a '
                }
                <a href="http://lorensr.me">freelance dev</a>
                {' who loves teaching and writing. He has worked on '}
                <a href="https://www.apollographql.com/">Apollo</a>
                {' (the #1 GraphQL client) as well as the Meteor '}
                <a href="https://guide.meteor.com/">Guide</a>
                {' and '}
                <a href="https://docs.meteor.com/">Docs</a>
                {". Together they're in the process of writing "}
                <em>the&nbsp;best</em>
                {' GraphQL reference, which includes:'}
              </p>
              <Delay ms={3500} initial={false} value>
                {ready => (
                  <StaggeredMotion
                    defaultStyles={_.times(
                      bookTopics.length,
                      _.constant(styles.listAnimation.default),
                    )}
                    styles={prevInterpolatedStyles =>
                      prevInterpolatedStyles.map((x, i) => {
                        if (!ready) {
              ...
              <section
                ...
                <LogoLI name="React & React Native">
                  ...
                  <svg
                    ...
                    <path
                      ...
                      strokeWidth="24"
                      strokeMiterlimit="10"
                      d="M299.53 197.628c67.355 0 129.927 9.665 177.106 25.907 56.844 19.57 91.794 49.233 91.794 76.093 0 27.99-37.04 59.503-98.083 79.728-46.15 15.29-106.88 23.272-170.818 23.272-65.555 0-127.63-7.492-174.29-23.44-59.047-20.183-94.612-52.104-94.612-79.56 0-26.642 33.37-56.076 89.415-75.616 47.355-16.51 111.472-26.384 179.486-26.384z"
                      />
                    <path
                      fill="none"
                      stroke="#00D8FF"
                      strokeWidth="24"
                      strokeMiterlimit="10"
                      d="M210.736 248.922c33.65-58.348 73.28-107.724 110.92-140.48 45.35-39.466 88.507-54.923 111.775-41.505 24.25 13.983 33.043 61.814 20.068 124.796-9.81 47.618-33.234 104.212-65.176 159.6-32.75 56.79-70.25 106.82-107.377 139.273-46.98 41.068-92.4 55.93-116.185 42.213-23.08-13.31-31.906-56.922-20.834-115.234 9.355-49.27 32.832-109.745 66.81-168.664z"
                      />
                    <path
                      fill="none"
                      stroke="#00D8FF"
                ...
                <LogoLI name="Android">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    <path
                      fill="#9FBF3B"
                      d="M301.314 83.298l20.16-29.272c1.196-1.74.898-4.024-.667-5.104-1.563-1.074-3.805-.543-4.993 1.2l-20.95 30.408c-13.808-5.44-29.14-8.47-45.3-8.47-16.16 0-31.496 3.028-45.302 8.47l-20.948-30.41c-1.2-1.74-3.44-2.273-5.003-1.2-1.563 1.078-1.86 3.363-.663 5.105l20.166 29.272c-32.063 14.916-54.548 43.26-57.413 76.34h218.316c-2.855-33.08-25.34-61.423-57.402-76.34"
                      />
                    <path
                      fill="#FFF"
                      d="M203.956 129.438c-6.673 0-12.08-5.407-12.08-12.08 0-6.67 5.404-12.08 12.08-12.08 6.668 0 12.073 5.408 12.073 12.08s-5.406 12.08-12.074 12.08M295.16 129.438c-6.667 0-12.073-5.407-12.073-12.08 0-6.672 5.406-12.08 12.074-12.08 6.676 0 12.08 5.41 12.08 12.08 0 6.672-5.406 12.08-12.08 12.08"
                      />
                    <path
                      fill="#9FBF3B"
                      d="M126.383 297.598c0 13.45-10.904 24.354-24.355 24.354-13.45 0-24.354-10.904-24.354-24.354V199.09c0-13.45 10.904-24.354 24.354-24.354s24.355 10.904 24.355 24.354v98.508zM140.396 175.49v177.914c0 10.566 8.566 19.133 19.135 19.133h22.634v54.744c0 13.452 10.903 24.355 24.354 24.355 13.45 0 24.355-10.903 24.355-24.354v-54.743h37.37v54.744c0 13.452 10.903 24.355 24.355 24.355s24.354-10.903 24.354-24.354v-54.743h22.633c10.57 0 19.137-8.562 19.137-19.133V175.49H140.396zM372.734 297.598c0 13.45 10.903 24.354 24.354 24.354 13.45 0 24.354-10.904 24.354-24.354V199.09c0-13.45-10.904-24.354-24.354-24.354s-24.354 10.904-24.354 24.354v98.508z"
                      />
                  </svg>
                </LogoLI>
              </section>
              ...
              <div
                ...
                <a href="https://twitter.com/graphqlguide">Twitter</a>
              </div>
            </section>
          </main>
        </Ripple>
